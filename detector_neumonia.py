...
# Definir la interfaz ImageReader
class ImageReader:
    def read_file(self, filename):
        # Este método debe ser implementado por las subclases
        raise NotImplementedError

# Implementar la interfaz ImageReader para los archivos DCM
class DicomReader(ImageReader):
    def read_file(self, filename):
        ds = pydicom.dcmread(filename) # leer el archivo DCM
...
# Implementar la interfaz ImageReader para los archivos JPEG
...
# Implementar la interfaz ImageReader para los archivos JPG
...
# Implementar la interfaz ImageReader para los archivos PNG
class PngReader(ImageReader):
    def read_file(self, filename):
        img = Image.open(filename) # abrir el archivo PNG como una imagen PIL
        array = img.load() # obtener la matriz de píxeles
        return array, img # devolver la matriz y la imagen
...
class App:
    def __init__(self, reader):
        self.root = Tk()
        # Inicializar el atributo reader con el objeto de lectura correspondiente
        self.reader = reader
...
# Crear un objeto de la clase ImageLoader
loader = App(None) # inicializar el atributo reader con None

# Crear un diccionario para mapear las extensiones con las clases de lectura
readers = {
    ".dcm": DicomReader(),
    ".jpeg": JpegReader(),
    ".jpg": JpgReader(),
...
if filepath:
    ...
    # Asignar el valor del atributo reader según la extensión
    loader.reader = readers[ext]
    # Llamar al método load_img_file del objeto loader
    loader.load_img_file()                
